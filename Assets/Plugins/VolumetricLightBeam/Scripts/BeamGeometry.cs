...
#define SRP_SUPPORT
using UnityExpNS = UnityEngine.Experimental.Rendering;
#endif
...
namespace VLB
{
    ...
    public class BeamGeometry : MonoBehaviour
    {
        ...
        {
            return UnityExpNS.RenderPipelineManager.currentPipeline != null || UnityEngine.Rendering.GraphicsSettings.renderPipelineAsset != null;
        }

        void OnEnable()
        {
            if (IsUsingCustomRenderPipeline())
                UnityExpNS.RenderPipeline.beginCameraRendering += OnBeginCameraRendering;
        }
